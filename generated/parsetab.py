...
_lr_productions = [
  ...
  ('structure -> SWITCH expression { programme }','structure',5,'p_structure_switch','parser5.py',85),
  ('structure -> CASE expression { programme BREAK }','structure',6,'p_structure_case','parser5.py',90),
  ...
  ('expression -> IDENTIFIER','expression',1,'p_expression_var','parser5.py',101),
  ('expression -> DIGIT','expression',1,'p_expression_num','parser5.py',106),
  ('expression -> TEXT','expression',1,'p_expression_text','parser5.py',111),
  ('expression -> TRUE','expression',1,'p_expression_bool','parser5.py',116),
  ('expression -> FALSE','expression',1,'p_expression_bool','parser5.py',117),
  ('expression -> ( expression )','expression',3,'p_expression_paren','parser5.py',122),
  ('expression -> ADD_OP expression','expression',2,'p_minus','parser5.py',127),
  ('type -> NUMBER','type',1,'p_type','parser5.py',132),
  ('type -> BOOL','type',1,'p_type','parser5.py',133),
  ('type -> TEXT','type',1,'p_type','parser5.py',134),
  ('type -> LIST','type',1,'p_type','parser5.py',135),
  ('assignation -> IDENTIFIER = expression','assignation',3,'p_assign','parser5.py',140),
  ('assignation -> BOOL IDENTIFIER = TRUE','assignation',4,'p_assign_bool','parser5.py',146),
  ('assignation -> BOOL IDENTIFIER = FALSE','assignation',4,'p_assign_bool','parser5.py',147),
  ('assignation -> NUMBER IDENTIFIER = DIGIT','assignation',4,'p_assign_number','parser5.py',153),
  ('assignation -> TEXT IDENTIFIER = CHARACTERS','assignation',4,'p_assign_text','parser5.py',159),
]
